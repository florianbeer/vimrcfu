...
@endif
  ...
  <div class="form-group">
    ...
    <p class="help-block small">You can use <strong>some markdown</strong> in your comment.<br>
    Italics (*), bold (**), inline code (`), code blocks without newlines (```) and blockquotes (>) are supported.</p>
  </div>
  <div class="form-group">
