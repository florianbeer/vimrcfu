...
class PagesController extends \BaseController {
    ...
    $top_snippet = DB::select(DB::raw('SELECT snippets.id, sum(votes.score) FROM snippets JOIN votes ON snippets.id = votes.snippet_id GROUP BY snippets.id ORDER BY votes.score DESC LIMIT 1'))[0];
